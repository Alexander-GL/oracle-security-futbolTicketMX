...
<?php
	...
	if (!empty($_POST))
	{
		...
		$query = "INSERT into pago values (pago_sequence.nextval, '$cantBoletos', '$idPartido', '$idCliente', '$zona')";
...
<script>
		...
		function validar()
		{
          ...
          function repage(){
               window.open("eliminarCompra.php");
          }
        ...
        <div class="row justify-content-center">
            <div class="container">
                <div class="form-box-signin">
                    ...
                    <h2 class="mt-0">INFORMACIÓN DE PAGO</h2>
                    <hr class="divider my-5" />
                    </div>
                    <!-- Form SIGNIN-->
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST" id="registrar" class="input-group">
                        <input type="number" name="cantBoletos" id="cantBoletos" class="input-field" placeholder="Cantidad Boletos" required pattern="[A-Za-z0-9]{1,15}">
                ...
                <div>
                    <input type="submit" class="submit-btn" value="Eliminar" onclick="repage()">
                </div>
            </div>
            <div class="curva">
