...
<?php
	...
	if (!empty($_POST))
	{
		...
		$query = "UPDATE boleto SET zona='$zona', precio='$precio' WHERE id_boleto='$idBoleto'";
        ...
        <div class="row justify-content-center">
            <div class="container">
                <div class="form-box-signin">
                    ...
                    <h2 class="mt-0">ACTUALIZAR DATOS DE BOLETO</h2>
                    <hr class="divider my-5" />
                    </div>
                    <!-- Form SIGNIN-->
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST" id="registrar" class="input-group">
                        <input type="number" name="idBoleto" id="idBoleto" class="input-field" placeholder="ID Boleto" required pattern="[A-Za-z0-9]{1,15}">
                        <input type="text" name="zona" id="zona" class="input-field" placeholder="Zona" required pattern="[A-Za-z0-9]{1,15}">
                        <input type="text" name="precio" id="precio" class="input-field" placeholder="Precio" required pattern="[A-Za-z0-9]{1,15}">
                        <input type="submit" class="submit-btn" name="registrar" value="Actualizar" onClick="validar()">
                    </form>
