...
<?php
	...
	if (!empty($_POST))
	{
		...
		$query = "INSERT into estadio values (estadio_sequence.nextval, '$nombreEstadio', '$direccion')";
        ...
        <div class="row justify-content-center">
            <div class="container">
                <div class="form-box-signin">
                    ...
                    <h2 class="mt-0">ESTADIOS LIGA MX</h2>
                    <hr class="divider my-5" />
                    </div>
                    <!-- Form SIGNIN-->
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST" id="registrar" class="input-group">
                        <input type="text" name="nombreEstadio" id="nombreEstadio" class="input-field" placeholder="Nombre Estadio" required pattern="[A-Za-z0-9]{1,15}">
                        <input type="text" name="direccion" id="direccion" class="input-field" placeholder="Direccion" required pattern="[A-Za-z0-9]{1,15}">
