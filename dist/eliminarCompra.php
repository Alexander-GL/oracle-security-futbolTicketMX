...
<?php
	...
	if (!empty($_POST))
	{
		...
		$query = "DELETE FROM BOLETO WHERE id_boleto='$idCompra'";
        ...
        <div class="row justify-content-center">
            <div class="container">
                <div class="form-box-signin">
                    ...
                    <h2 class="mt-0">ELIMINAR COMPRA</h2>
                    <hr class="divider my-5" />
                    </div>
                    <!-- Form SIGNIN-->
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST" id="registrar" class="input-group">
                        <input type="text" name="idCompra" id="idCompra" class="input-field" placeholder="ID Compra" required pattern="[A-Za-z0-9]{1,15}">
                        <input type="submit" class="submit-btn" name="registrar" value="Eliminar Compra" onClick="validar()">
                        <h8 class="col-12 my-2 text-center text-muted">Confirma que tu número de compra sea correcto</h8>
                    </form>
